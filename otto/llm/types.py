...
class ToolUseContent(TypedDict):
	...
	# Args
	_args: str | None  # used when streaming to store partial JSON
...
class TextContentChunk(TypedDict):
	"""
	TextContentChunk is used to stream content to the user.
	"""

	type: Literal["text", "thinking", "system"]
...
class ToolUseContentChunk(TypedDict):
	type: Literal["tool_use"]
	message: Literal["start", "end", "error", "content"]
...
ContentChunk = TextContentChunk | ToolUseContentChunk
